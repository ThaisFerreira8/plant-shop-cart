...
- ✅ Arquivos e códigos relacionados ao Redux

### Página de Destino (5 pontos)
- ✅ Imagem de fundo
- ✅ Parágrafo sobre a empresa
- ✅ Nome da empresa
- ✅ Botão Get Started com link

### Página de Listagem (9 pontos)
- ✅ Seis plantas domésticas exclusivas
- ✅ Agrupamento em três categorias
- ✅ Funcionalidade completa do botão Add to Cart
...
### Página do Carrinho (23 pontos)
- ✅ Contador total de plantas
- ✅ Cálculo do custo total
...
**Total: 50 pontos - Todas as 19 tarefas implementadas! 🎉**
